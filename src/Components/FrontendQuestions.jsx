...
//   return (
//     <div className=" w-full flex py-20 px-6 gap-6">
//       <div>
...
//       </div>
//       <div>
//         <div className="flex justify-center self-center rounded-sm bg-white pb-3   gap-10">
//           <div className=" font-semibold text-[#063b69] text-sm">
//             Testing Framework
//           </div>
//           <div className="px-3 py-3 bg-[#063b69] rounded-r-sm border-r-8 border-r-[#02213d]"></div>
//         </div>
//         <div className="flex justify-center self-center rounded-sm bg-white pb-3  gap-10">
//           <div className=" font-semibold text-[#063b69] text-sm">
//             Rainbow Circles
